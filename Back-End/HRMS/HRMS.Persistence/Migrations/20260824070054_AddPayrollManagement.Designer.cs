...
namespace HRMS.Persistence.Migrations
{
    ...
    [Migration("20260824070054_AddPayrollManagement")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HRMS.Domain.Entities.Payroll", b =>
                {
                    ...
                    b.HasIndex("OrganizationId", "PayrollPeriodStart", "PayrollPeriodEnd")
                        .IsUnique();

                    b.ToTable("Payrolls", (string)null);
                });

            modelBuilder.Entity("HRMS.Domain.Entities.PayrollItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("HRMS.Domain.Entities.AppUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
